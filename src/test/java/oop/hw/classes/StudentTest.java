...
class StudentTest {
    ...
    @Test
    void testInvalidGradeInConstructor() {
        assertThrows(IllegalArgumentException.class,
                () -> new Student("Оля", Arrays.asList(1, 2, 3)));

        assertThrows(IllegalArgumentException.class,
                () -> new Student("Коля", Arrays.asList(3, 6, 4)));
    }

    @Test
    void testInvalidGradeInAddGrade() {
        Student student = new Student("Таня");
    ...
    @Test
    void testInvalidGradeInSetGrades() {
        Student student = new Student("Миша", Arrays.asList(3, 4));

        assertThrows(IllegalArgumentException.class,
                () -> student.setGrades(Arrays.asList(2, 0, 5)));
